                  ...
                  <div class="col-lg-6 col-12 mt-3 mt-lg-0 mb-lg-0 mb-3">
                    <div class="product-info d-flex align-items-center">
                      <div class="product-image">
                        <img src="Views/template/images/product/product-1.webp" alt="Product" class="img-fluid" loading="lazy">
                      </div>
              ...
              <div class="cart-item">
                <div class="row align-items-center">
                  <div class="col-lg-6 col-12 mt-3 mt-lg-0 mb-lg-0 mb-3">
                    <div class="product-info d-flex align-items-center">
                      <div class="product-image">
                        <img src="Views/template/images/product/product-3.webp" alt="Product" class="img-fluid" loading="lazy">
                      </div>
                      <div class="product-details">
              ...
              <div class="cart-item">
                <div class="row align-items-center">
                  <div class="col-lg-6 col-12 mt-3 mt-lg-0 mb-lg-0 mb-3">
                    <div class="product-info d-flex align-items-center">
                      <div class="product-image">
                        <img src="Views/template/images/product/product-5.webp" alt="Product" class="img-fluid" loading="lazy">
                      </div>
                      <div class="product-details">
